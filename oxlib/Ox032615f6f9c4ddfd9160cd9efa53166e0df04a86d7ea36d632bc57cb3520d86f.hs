module Ox032615f6f9c4ddfd9160cd9efa53166e0df04a86d7ea36d632bc57cb3520d86f where 
...
-- ox export listOxImpurities
listOxImpurities :: String -> [String]
listOxImpurities contents =
  lines contents >>= \l ->
    case words l of
      ["--", "ox", "impurity", i] -> [i]
      _ -> []
